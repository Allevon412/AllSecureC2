...
#include "../../../headers/Crypt/wolfssl/wolfcrypt/settings.h"
#include "../../../headers/Crypt/wolfssl/wolfcrypt/types.h"
#include "../../../headers/Crypt/wolfssl/wolfcrypt/error-crypt.h"
#include "../../../headers/Crypt/wolfssl/wolfcrypt/logging.h"
#include "../../../headers/Crypt/wolfssl/wolfcrypt/wc_port.h"
#ifdef HAVE_ECC
    ...
    #include <wolfcrypt/port/cypress/psoc6_crypto.h>
#endif

#ifdef MAXQ10XX_MODULE_INIT
    #include <wolfcrypt/port/maxim/maxq10xx.h>
#endif
    ...
    #include <wolfcrypt/port/Renesas/renesas-tsip-crypt.h>
#endif
#if defined(WOLFSSL_RENESAS_FSPSM)
    #include <wolfcrypt/port/Renesas/renesas-fspsm-crypt.h>
#endif
#if defined(WOLFSSL_RENESAS_RX64_HASH)
    #include <wolfcrypt/port/Renesas/renesas-rx64-hw-crypt.h>
#endif
#if defined(WOLFSSL_STSAFEA100)
    #include <wolfcrypt/port/st/stsafe.h>
#endif
...
#include "../../../headers/Crypt/wolfssl/wolfcrypt/memory.h"
    ...
    #include <wolfcrypt/port/aria/aria-cryptocb.h>
#endif
#if defined(WOLFSSL_DEVCRYPTO)
    #include <wolfcrypt/port/devcrypto/wc_devcrypto.h>
#endif
#ifdef WOLFSSL_IMXRT_DCP
    #include <wolfcrypt/port/nxp/dcp_port.h>
#endif

#ifdef WOLF_CRYPTO_CB
    #include <wolfcrypt/cryptocb.h>
#endif

#ifdef HAVE_INTEL_QA_SYNC
    #include <wolfcrypt/port/intel/quickassist_sync.h>
#endif

#ifdef HAVE_CAVIUM_OCTEON_SYNC
    #include <wolfcrypt/port/cavium/cavium_octeon_sync.h>
#endif

#if defined(WOLFSSL_SE050) && defined(WOLFSSL_SE050_INIT)
#include <wolfcrypt/port/nxp/se050_port.h>
#endif
    ...
    #include <wolfcrypt/port/psa/psa.h>
#endif

#if defined(HAVE_LIBOQS)
    #include <wolfcrypt/port/liboqs/liboqs.h>
#endif
