...
func DecryptKeyIV(AESKey []byte, filepath, AgentName string) ([]byte, error) {

	DecryptedKeyOrIv, err := DecryptAESKeyIvInGo(AESKey, filepath+"Config\\"+AgentName+"_rsa_private_key.pem")
	if err != nil {
